...
public class TerminalOperationsReduce {
    ...
    private static void example1() {
        ...
        // It is a reduction, which means it processed all elements.
        ...
        // what is returned if a stream is empty. This means that there
        ...
        String name1 = Stream.of("s", "e", "a", "n")
                .reduce("", (s, c) -> s + c);
        System.out.println(name1); // sean
    ...
    private static void example2() {
        ...
        // returned because there may bot be any data (all the
        ...
        // Sometimes it is nice to know if the stream is empty as apposed
        // to the case where there is a value returned from the accumulator
        // that happens ti match the identity (however unlikely)
        Integer val = Stream.of(1, 1, 1)
                // .filter(n -> n > 5) // val is this way
                .reduce(1, (a, b) -> a); // val is this way too
    ...
    private static void example3() {
        ...
        Stream<String> stream = Stream.of("cars", "bus", "train", "aeroplane");
